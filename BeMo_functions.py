...
def main():
    ...
    notificationOffer = notification_offer(customer)

    notificationPayment = notify_customer_payment_status_with_gpt(customer)

    print(persona)
    print('*******************')
    print(greeting)
    print('*******************')
    print(notificationOffer)
    print('*******************')
    print(notificationPayment)
